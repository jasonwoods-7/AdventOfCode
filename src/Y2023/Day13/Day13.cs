...
{
    public IReadOnlyList<IReadOnlyDictionary<Coord, char>> ParseInput(
    ...
    static IEnumerable<Coord> GetLine(
    ...
    static Coord Opposite(Coord direction) => direction == Right ? Below : Right;
}
